...
export const asyncRoutes = [
...

  {
    ...
    children: [
      {
        path: 'user',
        component: () => import('@/views/otc/index'),
        name: 'user',
        meta: {
          perms: ['GET /admin/user/list'],
          title: 'otc订单管理',
...

  {
    ...
    children: [
      ...
      {
        path: 'set',
        component: () => import('@/views/money/set'),
        name: 'set',
        meta: {
          perms: ['GET /admin/user/list'],
          title: '手续费设置',
    ...
    children: [
      {
        ...
        name: 'list',
        meta: { title: '位置列表', icon: 'dashboard', affix: true }
      },
      {
        path: 'buy',
        component: () => import('@/views/location/buy'),
        name: 'buy',
        meta: { title: '购买列表', icon: 'dashboard', affix: true }
      }
      // {
      //   path: 'set',
      //   component: () => import('@/views/location/set'),
      //   name: 'set',
      //   meta: { title: '收益公式配置', icon: 'dashboard', affix: true }
      // }
    ]
  },
  {
